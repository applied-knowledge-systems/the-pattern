"""
This version creates a lightest possible aho-corasick automata from UMLS filtered by semantic types
Input dictionary controls relevance - it needs to be hand validated
...
counter=0
datafile=Path('./data/canonical_str_cui_semantic.tsv')
...
joblib.dump(t,"./automata/automata_fresh_semantic.pkl.lzma")