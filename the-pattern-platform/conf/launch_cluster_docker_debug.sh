...
docker run --name rgcluster -d -v $PWD/docker-config-debug.sh:/cluster/config.sh -v $DATA_DIR/rgcluster:/data -p 30001:30001 -p 30002:30002 -p 30003:30003 --rm --net $network_name rgcluster:latest
...
docker exec -it rgcluster /cluster/create-cluster call CONFIG SET LOGLEVEL DEBUG
